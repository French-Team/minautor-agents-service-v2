...
|---|---|---|---|---|
| 2026-09-02 | Audit file de relais ordonnee/classifiee (oracle v0.5.8, mission d552a4e3) | Frontmatter `oracle.md` `identite.version` = 0.5.3 alors que code 0.5.8, tableau Version 0.5.8 et versionning 0.5.8 - oubli de bump du champ frontmatter lors de la mise a jour de la doc | Signale dans le rapport (audit-oracle-file-relais-2026-09-02-1941.md) : a corriger par Vulcain (champ informatif, aucun impact logique) | Le champ `version:` du frontmatter d'un outil DOIT suivre la version du code - un versionning doc sans bump frontmatter passe sourdement (valider-tableaux ne pinne pas ce champ). Toujours verifier frontmatter vs code vs tableau de versionning lors d'un audit de version.
