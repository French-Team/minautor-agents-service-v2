...
| 2026-08-07 14:21 | Audit general post-activation | evaluer-agents signale 79 faux erreurs '__pycache__' comme des outils manquants -- les dossiers __pycache__ (artefacts Python) sont comptes comme des outils car os.walk liste tous les dossiers et match ^[a-z-]+$ (note: __pycache__ ne match PAS ce pattern... voir analyse) | Rapport : themis/rapports/audit-general-2026-08-07-14-21.md | A investiguer: le mecanisme exact par lequel evaluer-agents compte __pycache__ comme des outils. Probablement via lister-dossiers qui liste recursivement. CORRIGER evaluer-agents pour exclure __pycache__ et les dossiers de categorie (parents des outils)
| 2026-08-07 14:21 | Audit general post-activation | evaluer-coherence signale 4 faux outils casses (cat, grep, sed, basher) reference par athena -- ce sont des commandes systeme listees en exemple dans la regle 'OUTILS EXCLUSIFS' d'athena, pas des outils reels | Rapport : themis/rapports/audit-general-2026-08-07-14-21.md | evaluer-coherence doit ajouter une liste de commandes systeme connues a exclure, ou ignorer le contexte des regles interdites
