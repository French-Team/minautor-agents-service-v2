...
> **REGLE ABSOLUE -- PARCOURS (v0.4.6)** : Pour CHAQUE mission, je suis MON
...
**Parcours** : [cerveau-projet/agents/vulcain/parcours/parcours-vulcain.json](parcours/parcours-vulcain.json) (v0.4.4)
