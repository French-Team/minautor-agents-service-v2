...
**Statut :** ebauche
**Categorie :** Creer
**Chemin :** `agents/tools/creer/remplir-spec/`

## Description

Remplit les sections d'une spec **sans ouvrir le fichier**. L'agent donne la section et le contenu en arguments, l'outil insere le contenu a la bonne place. Complement de `squelette-spec` (qui genere la structure) : cet outil cree le contenu.

## Utilisation

```bash
# Remplir le titre
remplir-spec.sh spec-pipeline.001.01.ebauche.md titre "Spec du pipeline"

# Remplir le lien du pense-bete source
remplir-spec.sh spec-pipeline.001.01.ebauche.md parent "pense-bete-pipeline.001.01.ebauche.md"

# Remplir l'objectif
remplir-spec.sh spec-pipeline.001.01.ebauche.md objectif "Definir comment les pipelines fonctionnent"

# Remplir le contexte (multiligne avec \n)
remplir-spec.sh spec-pipeline.001.01.ebauche.md contexte "Origine : le besoin de decouplage\nPerimetre : les pipelines de traitement"

# Remplir les exigences
remplir-spec.sh spec-pipeline.001.01.ebauche.md exigences "Exigence 1 : communication via classeur"

# Apercu sans modifier
remplir-spec.sh spec-pipeline.001.01.ebauche.md objectif "Mon objectif" --dry-run
```
...
```bash
$ remplir-spec.sh spec-pipeline.001.01.ebauche.md objectif "Definir les pipelines"
...
| Outil | Complement |
|---|---|
| `squelette-spec` | Genere le squelette avant de remplir |
