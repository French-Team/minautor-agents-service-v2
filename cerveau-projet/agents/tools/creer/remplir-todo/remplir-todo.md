...
**Statut :** ebauche
**Categorie :** Creer
**Chemin :** `agents/tools/creer/remplir-todo/`

## Description

Remplit les sections d'un todo **sans ouvrir le fichier**. L'agent donne la section et le contenu en arguments, l'outil insere le contenu a la bonne place. Complement de `squelette-todo` (qui genere la structure) : cet outil cree le contenu des phases.

## Utilisation

```bash
# Remplir le titre
remplir-todo.sh todo-pipeline.001.01.ebauche.md titre "Todo du pipeline"

# Remplir le statut de l'intervention
remplir-todo.sh todo-pipeline.001.01.ebauche.md statut "| **Pense-bete** | cree | [lien] |"

# Remplir une phase (multiligne avec \n)
remplir-todo.sh todo-pipeline.001.01.ebauche.md phase5 "1. Creer le pipeline\n2. Documenter les resultats"

# Remplir l'historique
remplir-todo.sh todo-pipeline.001.01.ebauche.md historique "| 2026-08-06 | Phase 5 | Creation | [OK] |"

# Apercu sans modifier
remplir-todo.sh todo-pipeline.001.01.ebauche.md phase5 "Mon contenu" --dry-run
```
...
| Outil | Complement |
|---|---|
| `squelette-todo` | Genere le squelette avant de remplir |
