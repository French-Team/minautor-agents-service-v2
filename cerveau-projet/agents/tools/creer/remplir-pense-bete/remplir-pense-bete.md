...
**Statut :** ebauche
**Categorie :** Creer
**Chemin :** `agents/tools/creer/remplir-pense-bete/`
...
```bash
# Remplir le titre
remplir-pense-bete.sh pense-bete-pipeline.001.01.ebauche.md titre "Concept de Pipeline"

# Remplir l'idee
remplir-pense-bete.sh pense-bete-pipeline.001.01.ebauche.md idee "Le pipeline compose des fonctions de maniere decouplee"

# Remplir le probleme
remplir-pense-bete.sh pense-bete-pipeline.001.01.ebauche.md probleme "Comment communiquer entre fonctions sans les coupler ?"

# Remplir le contexte
remplir-pense-bete.sh pense-bete-pipeline.001.01.ebauche.md contexte "Ce pense-bete s'inscrit dans le developpement du cerveau"

# Remplir les liens (multiligne avec \n)
remplir-pense-bete.sh pense-bete-pipeline.001.01.ebauche.md liens "- Conventions : convention-pipelines.md\n- Regles : rvav-workflow.md"

# Apercu sans modifier
remplir-pense-bete.sh pense-bete-pipeline.001.01.ebauche.md idee "Mon idee" --dry-run
```
...
```bash
$ remplir-pense-bete.sh pense-bete-pipeline.001.01.ebauche.md idee "Le pipeline compose des fonctions"
...
| Outil | Complement |
|---|---|
| `squelette-pense-bete` | Cree le squelette avant de remplir |
