...
Modifier AGENTS.md de manière fiable et structuree.
...
```
modifier-agents-md(action="activer", agent="Buffy", raison="Mission correction")
```
...
| Lit cerberus.md | Lit le fichier de Cerberus pour la réactivation |
...
```
1. Appeler modifier-agents-md(action="reactiver", ...)
