...
CHARIOT = [
    ("detecter-residus", os.path.join(PROJECT_ROOT, "cerveau-projet", "agents",
                                      ...
                                      "detecter-residus.py")),
    ("detecter-processus-residuels", os.path.join(PROJECT_ROOT, "cerveau-projet",
                                                  "agents", "tools", "detecter",
                                                  "detecter-processus-residuels",
                                                  "detecter-processus-residuels.py")),
    ("nettoyer-processus-residuels", os.path.join(PROJECT_ROOT, "cerveau-projet",
                                                  "agents", "tools", "nettoyer",
