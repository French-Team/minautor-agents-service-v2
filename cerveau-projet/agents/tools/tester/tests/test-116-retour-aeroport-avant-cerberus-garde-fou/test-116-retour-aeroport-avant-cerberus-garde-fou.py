...
# ------------------------------------------------------------------
def point_1_code():
    """pilote.py v0.2.5 : RETOUR AEROPORT AVANT activer_cerberus."""
    ...
    if ok_existe:
        ...
        ok_version = (r.returncode == 0 and "0.2.5" in r.stdout)
    ...
    verifier("1. pilote.py v0.2.5 : RETOUR AEROPORT AVANT activer_cerberus",
