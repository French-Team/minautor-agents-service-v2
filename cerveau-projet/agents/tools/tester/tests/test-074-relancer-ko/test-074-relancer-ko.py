...
GARDE-FOU : l option --relancer-ko de tester-lancer-non-regression (v0.5.3)
...
Contexte :
  ...
  - Ce test verrouille : version 0.5.3, option dans --aide, fonction
...
def main():
    print("=== Garde-fou : --relancer-ko de tester-lancer-non-regression v0.5.3 ===")
