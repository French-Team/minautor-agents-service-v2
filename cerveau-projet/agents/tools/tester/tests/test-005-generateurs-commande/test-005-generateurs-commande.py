...
def main():
    print("=== Test 005 -- generateurs-commande v0.2.6 + catalogue 0.2.13 + parcours-atlas v0.5.0 ===")
    print("")
    ...
    try:
        ...
        verifier(14, "catalogue version = 0.2.13", cat.get("version") == "0.2.13", str(cat.get("version")))
