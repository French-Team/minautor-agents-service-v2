...
existe et fonctionne. Le lanceur tester-lancer-non-regression v0.5.3 journalise
...
Cas couverts:
  1. Le lanceur est v0.5.3 (--version)
...
def main():
    ...
    verifier("1. lanceur v0.5.3 (--version)", "v0.5.3" in out, out.strip())
