...
def main():
    try:
        ...
        # 6. index-tools : les 2 outils + compteurs Analyser 6 / Total 187
        if point_actif(6):
            t0 = time.monotonic()
