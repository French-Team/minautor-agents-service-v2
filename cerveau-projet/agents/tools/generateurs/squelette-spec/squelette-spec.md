...
**Chemin :** `agents/tools/generateurs/squelette-spec/`
...
squelette-spec.sh --theme pipeline

# Avec toutes les options
squelette-spec.sh --theme pipeline --id 001 --class 01 --dossier spec/ --parent pense-bete-pipeline.001.01.ebauche.md

# Apercu sans creer le fichier
squelette-spec.sh --theme pipeline --dry-run
```
...
```bash
$ squelette-spec.sh --theme pipeline --parent pense-bete-pipeline.001.01.ebauche.md
...
| `remplir-pense-bete` | Modele pour creer un outil de remplissage equivalent |
