# squelette-pense-bete

**Version :** 0.1.0-beta
**Statut :** ebauche
**Categorie :** Generateurs
**Chemin :** `agents/tools/generateurs/squelette-pense-bete/`
...
squelette-pense-bete.sh --theme pipeline

# Avec toutes les options
squelette-pense-bete.sh --theme pipeline --id 002 --class 02 --dossier cerveau-projet/pense-betes/

# Apercu sans creer le fichier
squelette-pense-bete.sh --theme pipeline --dry-run
```
...
| Outil | Complement |
|---|---|
| `remplir-pense-bete` | Remplit les sections du squelette |
