...
**Chemin :** `agents/tools/generateurs/squelette-todo/`
...
squelette-todo.sh --theme pipeline

# Avec toutes les options
squelette-todo.sh --theme pipeline --id 001 --class 01 --dossier spec/todo/

# Apercu sans creer le fichier
squelette-todo.sh --theme pipeline --dry-run
```
