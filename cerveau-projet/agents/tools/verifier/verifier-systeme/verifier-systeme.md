...
| `--bloc-fiche NOM` | Generer le bloc markdown `Environnement de travail (Systeme)` a inserer dans la fiche de l agent NOM (avec les differences Windows vs Linux) |
...
| 0.2.2-py | 2026-08-16 | Option `--bloc-fiche NOM` : genere le bloc Environnement de travail a inserer dans les fiches agents (demande utilisateur : ne pas oublier Windows vs Linux) |
