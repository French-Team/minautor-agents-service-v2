...
evaluer "Categorie explorer" "$dossier/cerveau-projet/agents/tools/explorer" "dossier"
...
evaluer_vide "Categorie explorer" "$dossier/cerveau-projet/agents/tools/explorer"
