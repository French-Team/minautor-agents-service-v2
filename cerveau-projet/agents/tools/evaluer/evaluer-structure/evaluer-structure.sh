...
evaluer "Dossier conventions" "$dossier/cerveau-projet/agents/conventions" "dossier"
evaluer "Dossier regles-immuables" "$dossier/cerveau-projet/agents/regles-immuables" "dossier"
evaluer "Dossier classeur-variables" "$dossier/cerveau-projet/agents/classeur-variables" "dossier"
...
evaluer "Index regles" "$dossier/cerveau-projet/agents/regles-immuables/index-regles-immuables.md" "fichier"
evaluer "Regle emojis-ascii" "$dossier/cerveau-projet/agents/regles-immuables/general/regles-emojis-ascii.md" "fichier"
evaluer "RVAV workflow" "$dossier/cerveau-projet/agents/regles-immuables/general/rvav-workflow.md" "fichier"
