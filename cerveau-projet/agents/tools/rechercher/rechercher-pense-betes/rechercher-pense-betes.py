...
# -*- coding: ascii -*-
"""
rechercher-pense-betes.py

Rechercher les pense-betes existants et eviter les doublons.

Options:
  --theme <motif>   Rechercher les pense-betes dont le theme est identique ou proche
  --tous            Lister tous les pense-betes existants (inventaire complet)
...
def afficher_aide():
    print("=== rechercher-pense-betes v%s ===" % VERSION)
    print("")
    print("Usage: rechercher-pense-betes.py [OPTIONS]")
    print("")
    print("Options :")
    print("  --theme <motif>   Rechercher les pense-betes dont le theme est identique ou proche")
    print("  --tous            Lister tous les pense-betes existants (inventaire complet)")
...
def main(argv):
    ...
    while i < len(argv):
        ...
        if arg in ("--help", "--aide", "-h"):
            ...
            continue
        if arg == "--version":
            print("rechercher-pense-betes v%s (%s)" % (VERSION, STATUT))
            return 0
