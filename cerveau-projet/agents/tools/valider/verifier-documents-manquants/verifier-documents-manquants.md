...
**Statut :** ebauche
**Categorie :** Valider
**Chemin :** `agents/tools/valider/verifier-documents-manquants/`
...
|---|---|---|
| **Script sans doc** | Un `.sh` existe mais pas de `.md` du meme nom | `protection-blocage.sh` sans `protection-blocage.md` |
...
| `test-*.md` | `test-modifier-agents-md.md` | Fichiers de test |
...
--- Scripts .sh sans documentation .md ---
  [MANQUANT] cerveau-projet/agents/tools/tests/protections/protection-blocage.sh
  [MANQUANT] cerveau-projet/agents/tools/tests/protections/protection-boucles-infinies.sh
  [MANQUANT] cerveau-projet/agents/tools/tests/protections/protection-erreurs-silencieuses.sh
