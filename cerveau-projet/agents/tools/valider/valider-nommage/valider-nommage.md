...
| 0.3.3 | 2026-08-12 | Round 7 : (a) `--recursive` sur une CATEGORIE directe (tools/valider) scanne ses outils au lieu de retourner Total 0 silencieux ; (b) formats speciaux etendus : `combo-*.md` (dossier combo-*), `tester-*-v0xx.(sh|py)` (scripts de test versionnes), `rapport-*-vNNN.md` (rapports documentaires) - 11 erreurs de bruit du scan global eliminees. Parite py/sh |
