...
source "$PROTECTIONS_DIR/protection-boucles-infinies.sh"
source "$PROTECTIONS_DIR/protection-erreurs-silencieuses.sh"
source "$PROTECTIONS_DIR/protection-blocage.sh"
