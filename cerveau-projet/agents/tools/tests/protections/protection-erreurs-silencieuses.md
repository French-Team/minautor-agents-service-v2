# protection-erreurs-silencieuses
...
source protection-erreurs-silencieuses.sh
...
protection-erreurs-silencieuses.sh "./mon-outil.sh --test" "Mon test" 0
```
...
| Outil | Complement |
|---|---|
| `protection-boucles-infinies` | Detecte les boucles infinies (en plus des erreurs) |
| `protection-blocage` | Detecte les tests qui bloquent sans erreur visible |
