...
source protection-boucles-infinies.sh
...
protection-boucles-infinies.sh "./mon-outil.sh --test" "Mon test" 30
```
...
| Outil | Complement |
|---|---|
| `protection-erreurs-silencieuses` | Detecte les erreurs silencieuses (en plus des boucles) |
| `protection-blocage` | Detecte les tests qui bloquent sans tourner en boucle |
