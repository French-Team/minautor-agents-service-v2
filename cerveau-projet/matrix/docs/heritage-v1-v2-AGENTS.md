...
# HERITAGE v1/v2 -- ARCHIVE DU CENSUS ET DES PROCEDURES D'ACTIVATION

> Archive posee le 2026-09-19 par MO-217 (EO-211) : le createur a tranche -- le
> census v1/v2 ne doit plus etre lu par un demarrage v3. Ce fichier conserve le
> bloc VERBATIM (aucune perte, aucune reecriture) ; AGENTS.md porte un pointeur.

> CE QUI EST VIVANT dans la v3 : le bloc session-matrix de AGENTS.md, le
> demarrage demarrer-optimus-prime.md, et tout cerveau-projet/matrix/.

> CE QUI RESTE DANS AGENTS.md : l'entete (lignee v1/v2), les blocs de session
> v1/v2 (leurs propres outils s'y ancrent), Sessions connues, le MARBRE
> (protege : seul l'agent Gardien peut en proposer la modification).

---

## BLOC DEPLACE -- VERBATIM (AGENTS.md, du 2026-09-19, lignes 106 a 223)
