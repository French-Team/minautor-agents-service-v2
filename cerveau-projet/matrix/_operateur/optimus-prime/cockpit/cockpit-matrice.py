...
Usage: python cockpit-matrice.py --route <etat|sante|flux1|flux2|chercher|metriques|complet> [--json] [--racine .] [--requete <texte>]
...
ROUTES_EXPANDED = ("etat", "sante", "flux1", "flux2", "chercher", "metriques")
...
def main():
    ...
    parser.add_argument("--route", default="complet", help="Route(s) : etat|sante|flux1|flux2|chercher|metriques|complet (virgule separee)")
