...
|---|---|
| `python super-combos/lancer-super-combos.py --lister` | Lister les super-combos |
| `python super-combos/lancer-super-combos.py --numero #N` | Lancer un super-combos |
| `python test-reel.py --fichier <fichier>` | Tester un fichier |
| `python test-reel.py --tout` | Tester tous les fichiers |
...
5. **Pour lancer un super-combos** : `python super-combos/lancer-super-combos.py --numero <#N>`
