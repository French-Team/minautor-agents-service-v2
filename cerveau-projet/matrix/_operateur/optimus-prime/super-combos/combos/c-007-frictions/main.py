...
# -*- coding: utf-8 -*-
"""
c-007-frictions -- Combo numerote c-007 dedie a la BDD Frictions detectees (frictions.db)

Genere par creer-combo.py (imperatif 46, contrat de nommage CV-008) le 2026-09-13 10:43:42.
...
COMBO_ID = "c-007-frictions"
COMBO_NUMERO = "c-007"
BDD_ID = "frictions"
BDD_TITRE = "Frictions detectees (frictions.db)"
OUTIL_BDD_REL = "_operateur/optimus-prime/super-combos/combos/outils/bdd-frictions/main.py"
COMMANDE_LIRE = "lister"
OPTION_FILTRE = "--mission-id"
