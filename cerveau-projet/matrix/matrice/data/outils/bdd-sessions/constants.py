"""Constantes de l'outil bdd-sessions.
...
# L'outil vit dans outils/bdd-sessions/ ; la BDD vit deux niveaux au-dessus (dans data/).
...
NOM_BDD = "sessions.json"
NOM_BDD_TMP = NOM_BDD + ".tmp"
CHEMIN_BDD = REPERTOIRE_DATA / NOM_BDD
CHEMIN_EMPREINTE = REPERTOIRE_DATA / (NOM_BDD + ".sha256")

# Prefixe des ids d'entree (CV-009 : un prefixe se DECLARE ici, jamais recopie
# dans le code qui l'emploie ; le controle des prefixes lit les constantes).
PREFIXE_ENTREE = "S-"
