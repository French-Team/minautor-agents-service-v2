"""Point d'entree global de l'outil bdd-activites.

Role : DIRIGER (parser la commande, router vers la categorie).
Aucune logique metier ici (convention-architecture-outils).

Usage :
    python main.py noter --section <missions|alertes|passes|decisions> --detail "..." --tags "a,b"
    python main.py lire [--section <nom>] [--tag <tag>]
