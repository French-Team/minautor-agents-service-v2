...
def charger_bdd():
    ...
    Chaque section pre-declaree existe toujours (eventuellement vide) :
    les emplacements sont precis des la naissance.
    """
    if not CHEMIN_BDD.exists():
        return {
            "identite": {"type": "bdd-activites", "version": 1},
            "sections": {nom: [] for nom in SECTIONS},
        }
