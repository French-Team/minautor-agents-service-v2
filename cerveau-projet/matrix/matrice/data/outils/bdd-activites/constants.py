"""Constantes de l'outil bdd-activites.
...
# L'outil vit dans outils/bdd-activites/ ; la BDD vit deux niveaux au-dessus (dans data/).
...
NOM_BDD = "activites-recentes.json"
NOM_BDD_TMP = NOM_BDD + ".tmp"
CHEMIN_BDD = REPERTOIRE_DATA / NOM_BDD
CHEMIN_EMPREINTE = REPERTOIRE_DATA / (NOM_BDD + ".sha256")

# Sections PRE-DECLAREES (emplacements precis, modele-mere : AGENTS-activite-recente).
# Une section non listee ici est REFUSEE : la structure ne derive jamais.
SECTIONS = ("missions", "alertes", "passes", "decisions")

# Rotation : chaque section garde au plus TAILLE_SECTION entrees (les plus recentes).
TAILLE_SECTION = 50

# Cles requises dans CHAQUE activite (controle structurel du verifier).
CLES_REQUISES = ("date", "detail", "tags")
