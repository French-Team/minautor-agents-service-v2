"""Constantes de l'outil bdd-protocoles-matrice.
...
# L'outil vit dans outils/bdd-protocoles-matrice/ ; la BDD vit deux niveaux au-dessus (dans data/).
...
NOM_BDD = "protocoles-matrice.json"
