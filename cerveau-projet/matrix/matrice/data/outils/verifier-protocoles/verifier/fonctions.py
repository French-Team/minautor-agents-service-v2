...
from commun import (
    detecter_non_ascii,
    lister_fichiers_protocoles,
    lire_lignes,
    verifier_frontmatter,
    verifier_index,
)
from constants import NOM_INDEX, REPERTOIRE_PROTOCOLES
...
def executer_verification():
    ...
    fichiers = lister_fichiers_protocoles()
    total = 0
    ...
    chemin_index = REPERTOIRE_PROTOCOLES / NOM_INDEX
