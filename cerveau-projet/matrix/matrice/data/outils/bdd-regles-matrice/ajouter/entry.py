"""Categorie ajouter : orchestre l'enregistrement d'une la regle taguee.
...
NOMS_OPTIONS = ("regle", "tags", "source")
...
def executer(arguments):
    ...
    if not contenu or not tags:
        print('Usage : python main.py ajouter --regle "..." --tags "a,b" [--source "..."]')
        return 2
    ...
    print(
        "La regle " + entree["id"] + " enregistree (tags : " + ", ".join(entree["tags"])
