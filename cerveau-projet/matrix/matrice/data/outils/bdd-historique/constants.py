"""Constantes de l'outil bdd-historique.
...
# L'outil vit dans outils/bdd-historique/ ; la BDD vit deux niveaux au-dessus (dans data/).
...
# Cles requises dans CHAQUE ligne du journal (controle structurel du verifier).
CLES_REQUISES = ("id", "date", "type", "detail", "tags")
