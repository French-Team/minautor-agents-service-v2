...
def verifier_index(lignes_index, fichiers_reels):
    """Compare l'index aux fichiers reels. Retourne (manquants, morts).

    L'index = les lignes de TABLEAU (commencant par '|') : les mentions
    en prose (ligne Sources, avertissements) ne comptent pas.
    """
    listes = set()
