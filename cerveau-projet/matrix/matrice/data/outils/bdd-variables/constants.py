"""Constantes de l'outil bdd-variables.
...
# L'outil vit dans outils/bdd-variables/ ; la BDD vit deux niveaux au-dessus (dans data/).
...
NOM_BDD = "classeur-variables.json"
...
# Cles requises dans CHAQUE variable (controle structurel du verifier).
CLES_REQUISES = ("id", "cle", "valeur", "date", "statut", "tags")

# Statuts possibles d'une variable (modele-mere : classeur v1).
STATUTS = ("[OK]", "[OBSOLETE]")
