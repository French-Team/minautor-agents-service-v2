"""Categorie rotation : borne le journal de la vigie en ARCHIVANT ses anciens.
...
connu" -- lecon L-040, course refusee) vit a UN seul endroit. La vigie ne
...
def executer(arguments):
    """Verbe `rotation` : borne le journal de la vigie en archivant ses anciens."""
    return cli(
        arguments,
        chemin_journal,
        SEUIL_OCTETS_JOURNAL,
